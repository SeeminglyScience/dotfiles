# Use ps1 instead of psd1 to preserve entry order.
return [ordered]@{
    ...
    Prefix1 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix2 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix3 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix4 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix5 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix6 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefix7 = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
    Prefixref = 'This API supports the product infrastructure and is not intended to be used directly from your code. This is a reserved instruction.'
